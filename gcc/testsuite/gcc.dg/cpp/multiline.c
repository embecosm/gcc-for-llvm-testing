...
/* { dg-warning "missing term" "multiline strings" { target *-*-* } 12 } */
/* { dg-warning "missing term" "multiline strings" { target *-*-* } 15 } */
/* { dg-warning "missing term" "multiline strings" { target *-*-* } 16 } */
/* { dg-warning "missing term" "multiline strings" { target *-*-* } 19 } */
